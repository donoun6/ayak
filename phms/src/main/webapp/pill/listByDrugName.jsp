	...
	table {
      ...
      <body>
        <div id="wrap">
          ...
          <!-- main -->
          <main id="main" style="padding: 50px 270px;">
		...
		<div style="border: 1px solid gray; border-radius: 20px; overflow: hidden; margin-bottom: 50px; ">
		<table class="main">
		<tr>
			<th>제품명</th>
			<td style="font-size: 21px; font-weight: bold;"><%=medi_list.get(i).getM_DrugName() %></td>
		</tr>
		<tr>
			<th>제품이미지</th>
			<td><img src='<%=medi_list.get(i).getM_DrugImage() %>' alt="이미지 없음" style="width:100px; height:50px;" onerror="this.style.display='none'"></td>
		</tr>
		<tr>
			<th>업체명</th>
